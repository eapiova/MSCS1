...
module Inductive.Measure where
...
open import Inductive.Substitution using (Subst ; subTy ; subTm ; liftSubst ; singleSubst)
...
open import Inductive.Substitution using (Ren ; renTy ; renTm ; raiseRen ; addRen ; wkTyBy ; wkTmBy)
