...
invMinimalQtrEq (minTransTy {B = tyNat} d _) with minimalTyEqHead d
... | ()
...
... | ()
invMinimalSigmaEq (minTransTy {B = tyNat} d _) with minimalTyEqHead d
... | ()
...
... | ()
invMinimalEqEq (minTransTy {B = tyNat} d _) with minimalTyEqHead d
... | ()
