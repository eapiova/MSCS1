...
mutual
  ...
  mDeriv-ctxWF≤ d@(fNat wf) =
    <⇒≤ (mDeriv-summand< d ≤-refl)
  mDeriv-ctxWF≤ d@(iZero wf) =
    <⇒≤ (mDeriv-summand< d ≤-refl)
  mDeriv-ctxWF≤ d@(iSuc dn) =
    ≤-via-< (mDeriv-ctxWF≤ dn) (mDeriv-summand< d ≤-refl)
  mDeriv-ctxWF≤ d@(iSucEq dnn') =
    ≤-via-< (mDeriv-ctxWF≤ dnn') (mDeriv-summand< d ≤-refl)
  mDeriv-ctxWF≤ d@(eNat dL dn da dl) =
    ≤-via-< (mDeriv-ctxWF≤ dn)
      (mDeriv-summand< d
        (≤-sum2-4 (mDeriv dL) (mDeriv dn) (mDeriv da) (mDeriv dl)))
  mDeriv-ctxWF≤ d@(eNatEq dL dnn' da daa' dl dll') =
    ≤-via-< (mDeriv-ctxWF≤ dnn')
      (mDeriv-summand< d
        (≤-sum2-6 (mDeriv dL) (mDeriv dnn') (mDeriv da) (mDeriv daa') (mDeriv dl) (mDeriv dll')))
  mDeriv-ctxWF≤ d@(cNatZ dL da dl) =
    ≤-via-< (mDeriv-ctxWF≤ da)
      (mDeriv-summand< d
        (≤-sum2-3 (mDeriv dL) (mDeriv da) (mDeriv dl)))
  mDeriv-ctxWF≤ d@(cNatS dL dn da dl) =
    ≤-via-< (mDeriv-ctxWF≤ dn)
      (mDeriv-summand< d
        (≤-sum2-4 (mDeriv dL) (mDeriv dn) (mDeriv da) (mDeriv dl)))
